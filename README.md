...
## 本项目获取地址：https://www.bishecode.com/product/95/
...
图5-1 教师管理页面【管理员可以对教师信息进行添加，修改，删除，查询操作】
![alt text](images/image-3.png)

图5-2 学院信息管理页面【管理员可以对学院信息信息进行添加，修改，删除，查询操作】
![alt text](images/image-4.png)

图5-3 科研课题管理页面【教师可以对科研课题进行添加，修改，删除，查询操作】
![alt text](images/image-5.png)

图5-4 软件著作权管理页面【教师可以对软件著作权进行添加，修改，删除操作】
![alt text](images/image-6.png)

图5-5 论文信息管理页面【教师可以对论文信息进行添加，修改，删除，查询操作】
